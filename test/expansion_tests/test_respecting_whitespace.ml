...
(* This file tests that whitespace is respected according to:
   ...
   We do up to 4 (except the "even across separate inline elements" part...) as doing 5
   is harder. A minimal viable approach is just not trimming any whitespace, although this
   makes expect tests uglier. Doing up to 4 results in the easiest cleaner expect test
   without needing to do the trimming need to depen on the context of consecutive elements.
*)
